    ...
    public static partial class FastEnum
    {
            ...
            where T : struct, Enum
        {
            ...
            static Cache_UnderlyingOperation()
            {
                ...
                {
                    case TypeCode.SByte:
                        UnderlyingOperation = SByteOperation<T>.Create(min, max, distincted);
                        break;
                    case TypeCode.Byte:
                        UnderlyingOperation = ByteOperation<T>.Create(min, max, distincted);
                        break;
                    case TypeCode.Int16:
                        UnderlyingOperation = Int16Operation<T>.Create(min, max, distincted);
                        break;
                    case TypeCode.UInt16:
                        UnderlyingOperation = UInt16Operation<T>.Create(min, max, distincted);
                        break;
                    case TypeCode.Int32:
                        UnderlyingOperation = Int32Operation<T>.Create(min, max, distincted);
                        break;
                    case TypeCode.UInt32:
                        UnderlyingOperation = UInt32Operation<T>.Create(min, max, distincted);
                        break;
                    case TypeCode.Int64:
                        UnderlyingOperation = Int64Operation<T>.Create(min, max, distincted);
                        break;
                    case TypeCode.UInt64:
                        UnderlyingOperation = UInt64Operation<T>.Create(min, max, distincted);
                        break;
                    default:
